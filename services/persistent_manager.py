...
class PersistenceManager:
    def __init__(self, progress_file, temp_progress_file, temp_csv_file):
        self.progress_file = progress_file
        self.temp_progress_file = temp_progress_file
    ...
    def save_progress(self, links, data, scraped_links, temp=False):
